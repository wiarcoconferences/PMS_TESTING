	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				iframe   : '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" scrolling="no" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0"' + ($.browser.msie ? ' allowtransparency="true"' : '') + '></iframe>',
		...
		_setDimension: function () {
			...
			if (scrollOut && scrolling === 'no' && height < origHeight && (width + wPadding + scrollOut) < maxWidth_) {
				width += scrollOut;
			}
